...
public class Kasirku {
	...
	public static void main (String [] args) { 
        ...
        int []stokbrg = {87,50,70,100,100};
	 	String barang[] = {"NIKEAR","ADIDIS","NEWBEN","ALLAS","PIET0"};
        ...
        do
        {
            ...
            System.out.println("Anda akan membeli sepatu "+barang[KodeBeli]);
            System.out.print("Masukkan jumlah pembelian sepatu "+barang[KodeBeli]+" : ");
            ...
            {
                System.out.println("Maaf stok sepatu yang anda pilih telah habis !");
                System.out.println("Stok sepatu masih tersedia " + stokbrg[KodeBeli]);
        ...
        System.out.println("---------------------------------------------------------------------------");
        System.out.println("------------------ TERIMAKASIH TELAH BERBELANJA DI DB SHOES----------------");
